      ...
      <main className="max-w-4xl mx-auto px-6 pt-32 pb-20">
        <header className="mb-12">
          <div className="flex items-center gap-3 mb-4 text-primary">
            ...
            <span className="text-xs font-bold tracking-[0.3em] uppercase">Irion // Satellite Bridge</span>
          </div>
        ...
        <div className="mt-12 p-6 rounded-3xl bg-primary/5 border border-primary/10 flex items-start gap-4">
           ...
           <p className="text-xs leading-relaxed text-foreground/60">
              Irion Satellite Bridges utilize **Chainlink CCIP (Cross-Chain Interoperability Protocol)** to securely transmit state proofs. 
